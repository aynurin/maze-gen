...
mono ~/.nuget/packages/altcover/8.6.68/tools/net472/AltCover.exe --outputDirectory=__Instrumented
...
nunit3-console --debug build/Debug/tests/tests.dll --output ./build/tests/
