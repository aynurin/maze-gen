...
namespace PlayersWorlds.Maps.Areas.Evolving {
    ...
    public class AreaDistributorIntegrationTest : Test {
        ...
        public void AreaDistributorTest_OverlapTwo(
            ...
            AreaDistributorHelper.Distribute(
                ...
                parts[1].Split(new char[] { ' ' }, StringSplitOptions.RemoveEmptyEntries)
                        .Select(s => LegacyAreaSerializer.ParseV01AreaString(s, isPositionFixed: false)),
                maxEpochs: 10)
                .AssertAllFit(_random);
        }
        ...
        public static IEnumerable<string> TestLayouts() {
            ...
            yield return "48x38: P8x15;S1x3 P45x11;S2x7 P6x8;S1x3 P4x7;S10x11 P4x9;S2x8 P26x13;S1x10 P18x13;S10x7 P35x22;S10x5 P31x10;S5x9 P32x10;S13x6 P22x22;S14x6 P26x1;S3x3 P28x14;S13x10 P24x4;S12x8"; // Overlapping: P18x8;S10x11 (Random(953)), P27x13;S10x5 (Random(953))
            ...
            yield return "24x46: P11x20;S3x9 P5x15;S6x10 P5x14;S7x13 P10x26;S5x11 P10x18;S1x4 P11x13;S1x5 P10x29;S6x9 P13x8;S2x10 P3x17;S7x13 P5x28;S5x5 P18x8;S5x12"; // Overlapping: P9x26;S3x9 (Random(850)), P8x34;S5x11 (Random(850)) // Overlapping: P14x24;S1x5 (Random(956)), P10x26;S5x5 (Random(956)) // Overlapping: P15x19;S6x9 (Random(412)), P9x16;S7x13 (Random(412))
            yield return "10x10: P7x9;S2x3 P7x2;S3x2 P3x9;S2x2 P0x5;S2x3 P7x1;S2x3 P0x0;S6x5"; // Out Of Bounds: P-1x3;S6x5 (Random(569)); Out Of Bounds: P-1x5;S6x5 (Random(292)) //  Out Of Bounds: P0x-1;S6x5 (Random(934)) //  Out Of Bounds: P3x-1;S6x5 (Random(854))
        }
