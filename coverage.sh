...
mono ~/.nuget/packages/altcover/8.6.68/tools/net472/AltCover.exe --assemblyFilter=Moq --typeFilter=Log --typeFilter=PlayersWorlds.Maps.Areas.Evolving.VectorDistanceForceProducer --pathFilter=./core/renderers --outputDirectory=__Instrumented
