...
mono $AltCover Runner --recorderDirectory __Instrumented --cobertura=../../coverage.cobertura.xml --executable "$nunit" -- __Instrumented/PlayersWorlds.Maps.Tests.dll --framework=mono-4.0 --where="Category!=Load"
cd ../../..
...
mono $nunit build/Debug/tests/PlayersWorlds.Maps.Tests.dll --framework=mono-4.0 --where="Category!=Load"
