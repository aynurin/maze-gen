...
//             var builder = new Maze2DBuilder(mazeLayer, new GeneratorOptions());
//             var generator = MazeGenerator.Create(
//                 GeneratorOptions.Algorithms.AldousBroder, _randomSource);
...
//             var renderer = new RenderedMazeAreaGenerator(
//                 _randomSource,
//                 CurrentLayer,
//                 options);
//             var layer = renderer.CreateMapArea();
//             layer.AddAreas(
//                 renderer.Generate() ??
//                 throw new InvalidOperationException(
//                     "No valid areas generated."));
